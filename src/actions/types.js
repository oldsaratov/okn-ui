const ACTION_TYPES = {
    ...
    // Event
    REQUEST_OBJECT_EVENT: 'REQUEST_OBJECT_EVENT',
    REQUEST_OBJECT_EVENT_SUCCESS: 'REQUEST_OBJECT_EVENT_SUCCESS',
    REQUEST_OBJECT_EVENT_FAILURE: 'REQUEST_OBJECT_EVENT_FAILURE',
